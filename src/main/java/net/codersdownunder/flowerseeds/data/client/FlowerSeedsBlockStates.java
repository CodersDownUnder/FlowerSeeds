...
public class FlowerSeedsBlockStates extends BlockStateProvider {
    ...
    public void makeCompatCrop(CropBlock block, String modid, String textureName) {
        ...
        ModelFile stage_0 = models().withExistingParent(block.getRegistryName().getPath().toString() + "_stage_0", modLoc("block/flower_stage_0"))
                .texture("texture",  new ResourceLocation(modid, textureName));;
        ModelFile stage_1 = models().withExistingParent(block.getRegistryName().getPath().toString() + "_stage_1", modLoc("block/flower_stage_1"))
                .texture("texture",  new ResourceLocation(modid, textureName));;
        ModelFile stage_2 = models().withExistingParent(block.getRegistryName().getPath().toString() + "_stage_2", modLoc("block/flower_stage_2"))
                .texture("texture",  new ResourceLocation(modid, textureName));;
        ModelFile stage_3 = models().withExistingParent(block.getRegistryName().getPath().toString() + "_stage_3", modLoc("block/flower_stage_3"))
                .texture("texture",  new ResourceLocation(modid, textureName));
    ...
    public void makeCrop(CropBlock block, String modid, String textureName) {
        ...
        ModelFile stage_0 = models().withExistingParent(block.getRegistryName().getPath().toString() + "_stage_0", modLoc("block/flower_stage_0"))
                .texture("texture",  new ResourceLocation(modid, "block/" + textureName));;
        ModelFile stage_1 = models().withExistingParent(block.getRegistryName().getPath().toString() + "_stage_1", modLoc("block/flower_stage_1"))
                .texture("texture",  new ResourceLocation(modid, "block/" + textureName));;
        ModelFile stage_2 = models().withExistingParent(block.getRegistryName().getPath().toString() + "_stage_2", modLoc("block/flower_stage_2"))
                .texture("texture",  new ResourceLocation(modid, "block/" + textureName));;
